...
public class SignUpServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            resp.sendRedirect("/E_Commerce_war_exploded/index.jsp?message=SignUp Successfully&checked=true&username=" + username); // redirect to login page or home page after successful registration
        } catch (Exception e) {
